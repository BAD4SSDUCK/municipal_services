...
class UsersConnectionsAll extends StatefulWidget {
  const UsersConnectionsAll({Key? key}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 5,),
                Text('Phone Number: ${_allPropertyResults[index]['cell number']}',
                  style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400),
                ),
                const SizedBox(height: 30,),
                Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            BasicIconButtonGrey(
                              onPress: () async {
                                String cell = _allPropertyResults[index]['cell number'];
                                    ...
                                    builder: (context) {
                                      return AlertDialog(
                                        ...
                                        actions: [
                                          ...
                                          IconButton(
                                            onPressed: () async {
                                              _disconnectThisUser(_allPropertyResults[index]);
                                              Navigator.pop(context);
                                            },
