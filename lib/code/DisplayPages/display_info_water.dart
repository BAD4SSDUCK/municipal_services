...
class UsersTableWaterPage extends StatefulWidget {
  const UsersTableWaterPage({Key? key}) : super(key: key);

  @override
  _UsersTableWaterPageState createState() => _UsersTableWaterPageState();
}
...
class _UsersTableWaterPageState extends State<UsersTableWaterPage> {
                ...
                children: [
                  ...
                  Visibility(
                    ...
                    child: TextField(
                      ...
                      decoration: const InputDecoration(labelText: 'Water Meter'),
                    ),
                  ),
                  Visibility(
                    visible: visibilityState1,
