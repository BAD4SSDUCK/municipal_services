  ...
  Future<void> _showMeterReadingUpdateUI(BuildContext parentContext) async {
    ...
    try {
      ...
      if (byId.exists) {
        ...
        if (data != null) {
          previousReading = (data['meter_reading'] ?? "0").toString();
        }
      } else {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        // child: Text(
                        //   'Previous (${prevMonth} ${prevYear}): $previousReading kW',
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          helperText: 'Enter the current month reading (kW).',
                          suffixText: 'kW',
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          isLoadingMeter
                            ...
                            onPressed: () async {
                              final String meterReading = meterReadingController.text.trim();

                              if (meterReading.isNotEmpty) {
                                if (mounted) setState(() => isLoadingMeter = true);
                                try {
                                  final updatedReading = await _callMeterReadingServiceAfterUpload(meterReading);
                                  ...
                                  debugPrint("Error updating electricity meter reading: $e");
                                  ScaffoldMessenger.of(parentContext).showSnackBar(
                                    const SnackBar(
                                      content: Text("Failed to update electricity meter reading"),
                                      duration: Duration(seconds: 2),
                                    ),
                                  );
                                } finally {
