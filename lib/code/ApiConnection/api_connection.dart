...
class API{
  ...
  static const hostConnect = "https://127.0.0.1:8080/connection.php"; //http://municipal_tracker.localhost:8080/ //localhost:8080 //I need to figure out what the host is for the running XAMPP mysql server
